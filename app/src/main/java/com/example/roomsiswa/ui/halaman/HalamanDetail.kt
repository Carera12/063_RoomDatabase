...
object DetailsDestination: DestinasiNavigai {
...
fun DetailsScreen(
    ...
    Scaffold(
        ...
        ItemDetailsBody(
            ...
            onDelete = {
                //I Note: If the user rotates the screen very fost, the operatien say get concelled
                //and the Iten noy not be deleted fron the Datebose. This Is because then config
                // change occurs, the Activity will
                // be recrested and the resenberceroutinescope I be concolled - since the scope is bound to composition,
...
private fun ItemDetailsBody(
    ...
    Column (
        ...
        ItemDetail(siswa = itemDetailsUiState.detailSiswa.toSiswa(),
